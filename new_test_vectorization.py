...
def main_testing(test_image_base_dir, test_dataset, test_image_raw_name,
    ...
    [test_set, eval_hps_model, sample_hps_model] \
        = load_dataset_testing(test_image_base_dir, test_dataset, test_image_raw_name, model_params)
...
def main(model_name, test_image_name, sampling_num):
    ...
    test_image_base_dir = '/home/curry/jshe2377/atd12k_points/test_2k_540p'

    sampling_base_dir = '/home/curry/jshe2377/atd12k_points/test_2k_vslabel'
